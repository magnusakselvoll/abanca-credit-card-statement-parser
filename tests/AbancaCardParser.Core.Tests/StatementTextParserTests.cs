...
[TestClass]
public class StatementTextParserTests
{
    private readonly StatementTextParser _parser = new();
    ...
    {
        Assert.AreEqual(9.99m, StatementTextParser.ParseSpanishDecimal("9,99"));
        Assert.AreEqual(1234.56m, StatementTextParser.ParseSpanishDecimal("1.234,56"));
        Assert.AreEqual(100.00m, StatementTextParser.ParseSpanishDecimal("100,00"));
        Assert.AreEqual(0.50m, StatementTextParser.ParseSpanishDecimal("0,50"));
    }
}
